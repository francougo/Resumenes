...
\begin{itemize}
        ...
        \item $\lim_{x \to a}[f(x)g(x)] = \lim_{x \to a}f(x) . \lim_{x \to a}g(x)$
        \item $\lim_{x \to a}\frac{f(x)}{g(x)} = \frac{\lim_{x \to a}f(x)}{\lim_{x \to a}g(x)}$ si $\lim_{x \to a}g(x) \neq 0$
        \item $\lim_{x \to a}[f(x)]^n = [\lim_{x \to a}f(x)]^n$ donde n es un entero positivo

\end{itemize}

\textbf{Teorema de la compresion}\\*
Si $f(x) \leq g(x)$, cuando x esta cerca de $a$, sin considerar en $a$, y los limites
de f y g existen cuando x tiende a $a$:\\*
\[\lim_{x \to a}f(x) \leq \lim_{x \to a}g(x)\]\\*
Si $f(x) \leq g(x) \leq h(x)$, cuando x esta cerca de $a$, sin considerar en $a$, y:\\*
